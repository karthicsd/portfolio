                ...
                <div className="page5-main-inner-outercard">
                    ...
                    <div className="page5-main-inner-p1">
                        ...
                        <p className="page5-main-inner-p1-p">Machine learning intern at Southern Taiwan University of
                            Science and Technology, Taiwan. Engaged in hands-on learning and contributed to innovative
                            projects in machine learning. Developed and implemented a spam detection project using text
                            mining, significantly enhancing word detection and classification of spam messages</p>
                    </div>
                </div>
                {/*card2*/}
                <div className="page5-main-inner-outercard">
                    ...
                    <div className="page5-main-inner-p1">
                        ...
                        <p className="page5-main-inner-p1-p">As the team leader, I guided our group to secure 1st place
                            in the Cognizant Technoverse 2023 hackathon with our healthcare-focused project, Medigree.
                            This achievement led to a one-month internship opportunity at Cognizant, where I gained
                            valuable hands-on experience and expanded my professional <skills className=""></skills></p>
                    </div>
                </div>
                {/*card3*/}
                <div className="page5-main-inner-outercard">
